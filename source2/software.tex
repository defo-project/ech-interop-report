...
\todo{Build each and run local interop confirmation tests}

\todo{build done: OpenSSL/boring/wolf/NSS; others tbd; add AWS-LC.}
...
\begin{longtblr} [
    ...
    \hline
        ...
        & Version: boringssl doesn't do versions, last local build 2025-09-21\\
    ...
    \hline
        ...
        & Version: 1.23 or later required, current: 1.24.4\\
        & ECH support: ECH shared-mode client and server\\

    \hline
        rustls & Source: \url{https://github.com/rustls/rustls/}\\
        & Version: 0.23.19, current: 0.23.32, not yet updated on test.defo.ie \\

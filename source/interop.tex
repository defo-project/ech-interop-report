...
\begin{itemize}
    ...
    \item Lines 51/52 - results here are currently affected by a misconfiguration
        of the expected outcome that was fixed on 2024-12-13; the situation
        seems to be that curl and CPython sypport use of P256, Chromium, Firefox
        and golang do not, and the rustls situation is being investigated by
        upstream developers.

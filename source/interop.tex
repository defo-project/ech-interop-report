...
\begin{itemize}
    ...
    \item Column 3 - Chromium seems to currently suffer relatively more badly from the
        ``impatiance'' problem with HTTPS RR DNS answer arrival times than
        other clients. For other clients, unexpected test outcomes seem to be
        more commonly due to inherent, but easily fixed, client limitations,
        such as not handling some ECH ciphersuites. (Again though: this
